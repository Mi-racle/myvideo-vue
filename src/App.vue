  ...
  <div>
    <header id="header" class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <nav :class="{collapse: true, 'navbar-collapse': true, show: showNav}" id="navbar">
        <ul class="navbar-nav">
          <li class="nav-item">
            <router-link active-class="active" :exact="true" :class="'nav-link' + ($route.path === '/' ? ' active' : '')"  :to="'/' | toLocale">{{$t('header.upload')}}</router-link>
          </li>
          <!-- TODO -->
          <li class="nav-item">
            <router-link active-class="active" :exact="true" :class="'nav-link' + ($route.path === '/list' ? ' active' : '')"  :to="'/list' | toLocale">{{$t('header.list')}}</router-link>
          </li>
          <li class="nav-item">
